...
import { setPriceRange } from 'src/features/events/EventSlice';
...
function MultiRangeSliderEvent() {
  // const [value, setValue] = useState([20, 37]);
  const { priceRange } = useSelector((state) => state.event);
...
export default MultiRangeSliderEvent;
