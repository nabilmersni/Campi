      ...
      slotProps={{
        root: (ownerState) => {
          ...
          return {
            ...resolvedSlotProps,
            className: clsx(
              'grid grid-cols-[1fr_8px] grid-rows-2 overflow-hidden font-sans rounded-lg text-slate-900  border-solid  bg-white   hover:border-violet-400 focus-visible:outline-0 p-1',
              ownerState.focused
                ? 'border-violet-400  shadow-outline-purple '
                : 'border-slate-300  shadow-sm shadow-slate-100 ',
        ...
        decrementButton: (ownerState) => {
          ...
          return {
            ...
            children: '▾',
            className: clsx(
              'font-[system-ui] flex flex-row flex-nowrap justify-center items-center p-0 w-[19px] h-[19px] border border-solid outline-none text-sm box-border leading-[1.2] rounded-b-md border-slate-200 border-t-0 bg-slate-50  text-slate-900  transition-all duration-[120ms] hover:cursor-pointer hover:bg-purple-500 hover:text-slate-50 col-start-3 col-end-3 row-start-2 row-end-3',
              resolvedSlotProps?.className,
            ),
          };
        },
